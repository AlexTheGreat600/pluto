...
func plutoHelp() {
        ...
        fmt.Println("")
        fmt.Printf("%s %s | %s\n", color.HiBlueString("*"), color.HiWhiteString("-uk "), color.HiWhiteString("--upperKebab"))
        fmt.Printf("%s %s | %s\n", color.HiYellowString("*"), color.HiWhiteString("-uc "), color.HiWhiteString("--upperCamel"))
        fmt.Printf("%s %s | %s\n", color.HiMagentaString("*"), color.HiWhiteString("-us "), color.HiWhiteString("--upperSnake"))
        fmt.Printf("%s %s | %s\n", color.HiCyanString("*"), color.HiWhiteString("-un "), color.HiWhiteString("--upperNormal"))
        fmt.Println("")
